    ...
    <v-card title="Login" class="bg-blue-grey-lighten-4">
        ...
        <v-form ref="formRef" v-model="formIsValid">
            ...
            <v-card-item>
                <v-row>
                    <v-col cols="12">
                        <v-text-field label="Email" variant="underlined" v-model="form.email" :error="!!errors.email"
                            :error-messages="errors.email"></v-text-field>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12">
                        <v-text-field label="Senha" variant="underlined" v-model="form.password"
                            ...
                            @click:append="passwordText = !passwordText"></v-text-field>
                    </v-col>
                </v-row>
            </v-card-item>
            ...
            <v-card-item>
                <v-row>
                    <v-col cols="12" class="d-flex justify-center" v-if="loaderView">
                        <v-progress-circular color="green" indeterminate></v-progress-circular>
                    </v-col>
                    <v-col cols="12" v-if="alertErrorView">
